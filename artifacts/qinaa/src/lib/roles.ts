...
export const ROLE_META: Record<string, { color: string; glow: string; desc: string }> = {
  "الولد":   { color: "#D32F2F", glow: "#D32F2F33", desc: "يختار ضحية كل ليلة ويحاول البقاء مجهولاً." },
  "الإكة":   { color: "#B71C1C", glow: "#B71C1C33", desc: "يُسكّت لاعباً ويمنعه من الكلام صباحاً." },
  "الشايب":  { color: "#FF8F00", glow: "#FF8F0033", desc: "يكشف انتماء لاعب كل ليلة: مافيا أو بريء أو مجنون." },
  "البنت":   { color: "#1565C0", glow: "#1565C033", desc: "تحمي لاعباً من القتل في تلك الليلة." },
