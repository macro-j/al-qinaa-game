...
export function PrivacyModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <ModalShell title="سياسة الخصوصية" onClose={onClose}>
      <p>نحن في لعبة القناع نحترم خصوصيتكم ونلتزم بحماية بياناتكم وفق أعلى المعايير. توضّح هذه السياسة كيفية تعاملنا مع بياناتكم أثناء استخدام القناع وخدماته المدفوعة.</p>
      ...
      <p><span className="text-white font-bold">المشتريات والاشتراكات:</span> يوفّر القناع تجربة مجانية محدودة بجولتين، إضافةً إلى مشتريات لمرة واحدة تشمل اللعبة الأساسية، وإضافات الأدوار الفردية، وباقة الوصول الشامل (VIP). نحتفظ بسجلّ مشترياتكم لتفعيل المحتوى الذي حصلتم عليه واستعادته عند الحاجة.</p>
      ...
      <p><span className="text-white font-bold">الأمان:</span> نطبّق أفضل الممارسات الأمنية لحماية تجربتكم ومعاملاتكم داخل القناع.</p>
...
export function TermsModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <ModalShell title="الشروط والأحكام" onClose={onClose}>
      <p>باستخدامكم لعبة القناع، فإنكم توافقون على الشروط والأحكام التالية:</p>
      <p><span className="text-white font-bold">الاستخدام:</span> القناع مخصّص للاستخدام الترفيهي الشخصي في المجالس والتجمعات. يُحظر استخدامه لأي غرض غير قانوني أو إعادة بيعه دون إذن.</p>
      <p><span className="text-white font-bold">التجربة المجانية:</span> يتيح القناع تجربة مجانية محدودة بجولتين لاستكشاف أجواء اللعبة قبل الشراء.</p>
      <p><span className="text-white font-bold">المشتريات الرقمية:</span> تشمل المشتريات: اللعبة الأساسية (لعب غير محدود للأدوار الرئيسية)، وإضافات الأدوار الفردية، وباقة الوصول الشامل (VIP) بسعر 29.99 ر.س التي تمنح جميع الأدوار الحالية والمستقبلية. جميعها مشتريات لمرة واحدة ما لم يُذكر خلاف ذلك.</p>
      ...
      <p><span className="text-white font-bold">الملكية الفكرية:</span> جميع حقوق الملكية الفكرية للعبة القناع — التصميم والكود والمحتوى — محفوظة لصانعيها.</p>
      <p><span className="text-white font-bold">إخلاء المسؤولية:</span> القناع مقدَّم «كما هو» دون أي ضمانات صريحة أو ضمنية، ولا نتحمل المسؤولية عن أي خسائر ناتجة عن الاستخدام.</p>
