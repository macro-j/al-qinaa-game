      ...
      <div className="flex flex-col items-center gap-10 w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-3xl">
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-5 rounded-2xl transition-all duration-200 active:scale-95"
            ...
            {/* CENTER: text — flex-1 fills space, text-right pins content flush to the icon */}
            <div className="flex flex-col items-end gap-1 flex-1 text-right mx-4">
              <div className="flex items-center gap-2">
      ...
      {showPrivacy && (
        <div
          ...
          <div
            ...
            onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center gap-2">
              <span className="font-black text-base text-white">سياسة الخصوصية</span>
            </div>
            <div style={{ height: "1px", backgroundColor: "rgba(255,255,255,0.06)" }} />
      ...
      {showTerms && (
        <div
          ...
          <div
            ...
            onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center gap-2">
              <span className="font-black text-base text-white">الشروط والأحكام</span>
            </div>
            <div style={{ height: "1px", backgroundColor: "rgba(255,255,255,0.06)" }} />
            <div className="flex flex-col gap-3 text-sm leading-relaxed text-right" style={{ color: "#AAAAAA" }}>
      ...
      {showSupport && (
        <div
          ...
          <div
            ...
            <div style={{ height: "1px", backgroundColor: "rgba(255,255,255,0.06)" }} />
            <div className="flex flex-col gap-3">
              {/* WhatsApp — dir="rtl" on the anchor, plain flex: icon RIGHT, text LEFT */}
              <a
                dir="rtl"
                href="https://wa.me/639756108041"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-200 active:scale-[0.97]"
                ...
                {/* LEFT: text — flex-1 + text-right flush to icon */}
                <div className="flex flex-col items-end gap-0.5 flex-1 text-right">
                  <span className="font-black text-sm" style={{ color: "#25D366" }}>تواصل عبر واتساب</span>
                  <span className="text-xs" style={{ color: "#4A7A5A" }}>ردّ سريع خلال ساعات</span>
                </div>
              </a>
              {/* Email — same fix */}
              <a
                ...
                {/* LEFT: text — flex-1 + text-right flush to icon */}
                <div className="flex flex-col items-end gap-0.5 flex-1 text-right">
                  <span className="font-black text-sm" style={{ color: "#4285F4" }}>تواصل عبر البريد</span>
                  <span className="text-xs" style={{ color: "#3A4A7A" }}>qinaa.support@gmail.com</span>
                </div>
              </a>
            </div>
          </div>
